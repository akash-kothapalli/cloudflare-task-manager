  ...
  try {
    ...
    if (error instanceof AppError) {
      ...
      switch (error.statusCode) {
        case 400: return badRequest(error.message, error.code);
        ...
        default:  return internalError(error.message);
      }
    }
    ...
    if (
      ...
      switch (e.status) {
        case 400: return badRequest(e.message);
        case 401: return unauthorized(e.message);
        case 403: return forbidden(e.message);
        case 404: return notFound(e.message);
        case 409: return conflict(e.message);
        default:  return internalError(e.message);
      }
    }
