...
export function validateUpdateTaskInput(body: unknown): ValidationResult<UpdateTaskInput> {
	...
	return {
		...
		value: {
			...
			description: b.description === null ? null : typeof b.description === 'string' ? b.description.trim() : undefined,
			status: b.status as TaskStatus | undefined,
			priority: b.priority as TaskPriority | undefined,
			due_date: b.due_date === null ? null : typeof b.due_date === 'string' ? b.due_date : undefined,
			tag_ids: Array.isArray(b.tag_ids) ? (b.tag_ids as number[]) : undefined,
		},
	};
}
...
export function validateCreateTagInput(body: unknown): ValidationResult<CreateTagInput> {
	if (typeof body !== 'object' || body === null) {
		return { ok: false, error: 'Request body must be a JSON object' };
	}
